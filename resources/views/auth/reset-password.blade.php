...
$request->email ?? old('email') }}" class="form-input mt-1 block w-full rounded-md
...
focus:border-indigo-600" placeholder="Password">
            ...
            <label class="block mt-3">
                <span class="text-gray-700 text-sm">Konfirmasi
                    Password</span>
                <input type="password" name="password_confirmation" class="form-input mt-1 block w-full rounded-md
focus:border-indigo-600" placeholder="Konfirmasi Password">
                @error('password')
                <div class="inline-flex max-w-sm w-full bg-red-200
shadow-sm rounded-md overflow-hidden mt-2">
                    <div class="px-4 py-2">
            ...
            <div class="mt-6">
                <button type="submit" class="py-2 px-4 text-center bg-indigo-600 roundedmd w-full text-white text-sm hover:bg-indigo-500 focus:outline-none">
                    UPDATE PASSWORD
                </button>
            </div>
        </form>
