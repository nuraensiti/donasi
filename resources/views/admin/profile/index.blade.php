...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="bg-green-500 p-3 rounded-md shadow-sm mt-3">
            ...
            @endif
            @if (session('status')=='password-updated')Password has been updated.
            @endif
...
url('user/two-factor-authentication') }}">
                            @csrf
                            <button type="submit" class="px-4 py-2 bg-gray-600 text-
...
url('user/two-factor-authentication') }}">
                            @csrf
                            @method('DELETE')<button type="submit" class="px-4 py-2 bg-red-600 text-
...
url('user/two-factor-recovery-codes') }}">
                            @csrf
                            <button type="submit" class="mt-4 px-4 py-2 bg-gray-600
...
old('name') ?? auth()->user()->name }}" class="form-input mt-1 block w-full
rounded-md" placeholder="Nama Lengkap">
                                @error('name')
                                <div class="inline-flex max-w-sm w-full
...
sm">{{ $message }}</p>
                        ...
                        <div class="mt-4">
                            <label class="block">
                                ...
                                <input type="email" name="email" value="{{ old('email') ?? auth()->user()->email }}" class="form-input mt-1 block w-full
...
sm">Password Lama</span>
                                <input type="password" name="current_password" class="form-input mt-1 block w-full
...
sm">Password Baru</span>
                                <input type="password" name="password" class="form-input mt-1 block w-full rounded-md" placeholder="Password Baru">
                            </label>
                        </div>
                        <div class="mt-4">
                            <label class="block">
...
sm">Konfirmasi Password Baru</span>
                                <input type="password" name="password_confirmation" class="form-input mt-1 block w-full
rounded-md" placeholder="Konfirmasi Password
Baru">
                            </label>
                        </div>
                        <div class="flex justify-start mt-4">
