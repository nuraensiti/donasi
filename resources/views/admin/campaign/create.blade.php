...
$message }}</p>
                    ...
                    <div>
                        <label class="text-gray-700" for="name">TARGET
                            DONASI</label>
                        <input class="form-input w-full mt-2 rounded-md
bg-gray-200 focus:bg-white p-3" type="number" name="target_donation" value="{{ old('target_donation') }}" placeholder="Target Donasi, Ex:
10000000">
...
text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bggray-700">SIMPAN</button>
                </div>
            </form>
        </div>
    </div>
