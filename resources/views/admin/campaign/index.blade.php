...
px-4 py-2 shadow-sm rounded-md">
            ...
            <div class="relative mx-4">
                <span class="absolute inset-y-0 left-0 pl-3 flex itemscenter">
...
pr-4" type="text" name="q" value="{{ request()->query('q') }}" placeholder="Search">
                </form>
            </div>
        </div>
...
px-4 py-2 rounded shadow-sm text-xs text-white focus:outlinenone">EDIT</a>
                                <button onClick="destroy(this.id)" id="{{ $campaign->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm
text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                        @empty
                        <div class="bg-red-500 text-white textcenter p-3 rounded-sm shadow-md">
                            Data Belum Tersedia!
                        </div>
                        @endforelse
                    </tbody>
